...
var YouTube = function (_Base) {
  ...
  function YouTube() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(YouTube)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.isReady = false, _this.startOnPlay = true, _this.durationOnPlay = false, _this.seekOnPlay = null, _this.playerId = PLAYER_ID + '-' + playerIdCount++, _this.onStateChange = function (_ref) {
      var data = _ref.data;
  ...
  _createClass(YouTube, [{
    ...
    value: function load(url) {
      ...
      var playerVars = this.props.youtubeConfig ? this.props.youtubeConfig.playerVars : {};
      if (this.props.loop) {
        playerVars = _extends({}, playerVars, { loop: 1, playlist: id });
      }
          ...
          events: {
            onReady: function onReady() {
              ...
              if (_this2.props.onReady) {
                _this2.props.onReady.forEach(function (func) {
                  func(_this2);
                });
              }
              _this2.onReady();
